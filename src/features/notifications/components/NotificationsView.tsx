        ...
        {notifications.length > 0
          ? notifications.map((n) => (
            <div
              ...
              className={`p-5 rounded-[1.5rem] border transition-all cursor-pointer hover:scale-[1.01] active:scale-95 ${
                n.is_read
                  ? "bg-white border-gray-100 opacity-80 shadow-sm"
              ...
              <div className="flex gap-4">
                <div
                  className={`mt-1 p-3 rounded-2xl ${
                    (n.title || "").includes("משימה")
                      ? "bg-blue-50 text-blue-600"
                      : (n.title || "").includes("הצעה")
                      ? "bg-orange-50 text-orange-600"
                      : (n.title || "").includes("אישור")
