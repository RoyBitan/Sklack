      ...
      <div className="w-full max-w-2xl card-premium p-12 md:p-20 text-center relative overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-12">
          ...
          <p className="text-gray-500 font-bold text-lg max-w-md mx-auto leading-relaxed">
            מנהל המוסך יאשר את הצטרפותך בקרוב. תקבל גישה מלאה למערכת לאחר
            האישור.
          </p>
        </div>
        ...
        <div className="mt-12 border-t border-gray-100 pt-8">
          <button
            onClick={signOut}
            className="text-gray-400 font-black text-sm uppercase tracking-widest hover:text-red-500 transition-colors"
          >
            התנתקות מהחשבון
          </button>
        </div>
