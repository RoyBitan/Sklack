...
import {
  ...
  isValidIsraeliPlate,
} from "@/shared/utils/vehicleApi";
import {
  playClickSound,
  scrollToFormStart,
  scrollToTop,
} from "@/shared/utils/uiUtils";
...
const AddVehicleModal: React.FC<AddVehicleModalProps> = (
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (existingVehicle) {
        // Update existing vehicle instead of throwing error
  ...
  return (
    <div
      className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[250] flex items-center justify-center p-4 sm:p-6 animate-fade-in"
      onClick={(e) => e.stopPropagation()}
    >
      <div
        ref={scrollRef}
        className="bg-white w-full max-w-xl rounded-[2.5rem] shadow-2xl relative flex flex-col max-h-[90dvh] overflow-hidden border-t-[8px] sm:border-t-[12px] border-blue-600"
      >
        {/* Header */}
        <div className="flex-none p-6 pb-2 flex items-center justify-between border-b border-gray-50">
          <div className="text-start">
            <div className="bg-blue-50 w-10 h-10 rounded-xl flex items-center justify-center mb-1 text-blue-600">
              <Car size={20} />
            </div>
            ...
            <p className="text-gray-400 font-bold text-[10px] uppercase tracking-widest leading-none">
              הוספת רכב למאגר המוסך
            </p>
          </div>
          <button
            onClick={onClose}
            className="p-2 bg-gray-100 rounded-full hover:bg-black hover:text-white transition-all"
          >
            <X size={20} />
          </button>
        </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <input
                  type="text"
                  required
                  className="input-premium font-mono tracking-widest text-center text-xl h-14 w-full pr-14"
              ...
              <div className="space-y-4 animate-fade-in-up bg-gray-50/50 p-6 rounded-3xl border border-dashed border-gray-200 text-start">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <input
                      type="text"
                      className="input-premium h-12 font-mono tracking-widest text-start bg-white border-gray-100 uppercase"
                      placeholder="1234"
                      value={kodanit}
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      type="text"
                      className="input-premium h-12 bg-white border-gray-100 uppercase font-mono text-sm"
                      placeholder="G4FC"
                      value={engineModel}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <input
                      type="text"
                      className="input-premium h-12 bg-white border-gray-100"
                      placeholder="לבן"
                      value={color}
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      type="text"
                      className="input-premium h-12 bg-white border-gray-100 text-left font-mono text-sm"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <input
                      type="text"
                      className="input-premium h-12 font-mono text-xs bg-white border-gray-100 uppercase"
                      placeholder="VMF1..."
                      value={vin}
