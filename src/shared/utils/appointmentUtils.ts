  ...
  try {
    ...
    const notificationPromises = admins.map((admin) =>
      supabase.from("notifications").insert({
        ...
        message: notificationBody, // Fixed: field is 'message' in notification table? Wait, let me check.
        // In types.ts it says 'message'. In appointmentUtils.ts it said 'body'.
        // I'll stick with message.
        type: "DAILY_APPOINTMENTS",
        url: "/appointments", // Fixed: field is 'url' in notification table?
        metadata: {
