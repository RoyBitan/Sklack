...
const VehiclesView: React.FC = () => {
    ...
    return (
        <div className="space-y-10 animate-fade-in-up">
            ...
            {loading ? (
                <div className="col-span-full text-center py-20 font-black text-gray-300 uppercase tracking-widest animate-pulse-slow">טוען רכבים...</div>
                    ...
                    <div className="md:hidden grid grid-cols-1 gap-6">
                        {filteredVehicles.map(v => (
                            <div key={v.id} className="card-premium p-8 group">
                                ...
                                <div className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-6">{v.year || '-'} • {v.color || '-'}</div>
                            ...
                            <tbody className="divide-y divide-gray-50">
                                {filteredVehicles.map(v => (
                                    <tr key={v.id} className="group hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td className="px-8 py-6">
                                            <button className="text-xs font-black underline hover:text-blue-600">ערוך</button>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
