...
import { TaskStatus, Priority, Task, UserRole } from '../types';
import TaskCard from './TaskCard';
import { Search, Plus, Clock, Wrench, CheckCircle2, AlertCircle, Filter } from 'lucide-react';
...
const TasksListView: React.FC = () => {
    ...
    const getStatusLabel = (s: TaskStatus) => {
        switch (s) {
            ...
            case TaskStatus.APPROVED: return 'אושר';
            ...
            case TaskStatus.WAITING_FOR_APPROVAL: return 'ממתין לאישור';
        ...
        <div className="space-y-6 md:space-y-8 animate-fade-in-up">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div className="text-start">
                    <h1 className="text-3xl font-black text-gray-900 tracking-tight">ניהול משימות</h1>
                    <p className="text-gray-500 font-bold mt-1">צפה ונהל את כל המשימות הפעילות במוסך</p>
                </div>
                {isAdmin && (
                    <button
                ...
                <div className="flex gap-2 overflow-x-auto pb-2 md:pb-0 scrollbar-hide">
                    {[
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-6 h-14 md:h-16 rounded-2xl font-black whitespace-nowrap transition-all ${statusFilter === filter.id
            ...
            <div className="space-y-4">
                {filteredTasks.length > 0 ? (
                    ...
                    <div className="bg-white rounded-[2.5rem] p-20 text-center border-2 border-dashed border-gray-100 py-32">
                        ...
                        <h3 className="text-xl font-black text-gray-900 mb-2">לא נמצאו משימות</h3>
                        <p className="text-gray-500 font-bold mb-8">נסה לשנות את מסנני החיפוש שלך</p>
                        <button
